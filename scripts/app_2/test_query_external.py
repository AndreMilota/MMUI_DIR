# scripts/app_2/test_query_external.py
"""
Tests for the query_external branch of the app_2 LangGraph workflow.

query_external handles requests to invoke an external application or
command-line tool (e.g., ffmpeg, ImageMagick) on a set of files.
"""
import os
...
def test_all_external():
    """Run all query_external tests."""
    print("\n" + "#"*70)
    print("# RUNNING ALL query_external TESTS")
    print("#"*70)

    test_query_external()

    print("\n" + "#"*70)
    print("# query_external TESTS COMPLETED")
    print("#"*70)
