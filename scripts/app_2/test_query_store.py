# scripts/app_2/test_query_store.py
"""
Tests for the query_store branch of the app_2 LangGraph workflow.

query_store handles multi-turn dialog requests where the user asks the
agent to "remember" or "note down" a set of files for later reference.
The result is stored as a table in agent state for follow-up actions.
"""
import os
...
def test_all_store():
    """Run all query_store tests."""
    print("\n" + "#"*70)
    print("# RUNNING ALL query_store TESTS")
    print("#"*70)

    test_query_store()

    print("\n" + "#"*70)
    print("# query_store TESTS COMPLETED")
    print("#"*70)
